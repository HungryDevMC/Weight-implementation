package be.jflanders.weight_impl._2Business.frameworks.registry;

import be.jflanders.weight_impl._2Business.frameworks.registry.enums.LogType;
import be.jflanders.weight_impl._2Business.frameworks.registry.interfaces.Loggable;
...
public abstract class AbstractPlugin extends JavaPlugin implements Loggable {
    ...
    public void onDisable() {
        log(LogType.WARNING, "SAVING ALL KINGDOM AND PLAYER DATA!");
        MODULES.values().forEach(AbstractModule::onDisable);
    }
    ...
    private void registerModules() {
        ...
        Reflections reflections = new Reflections("be.jflanders.weight_impl._2Business");
